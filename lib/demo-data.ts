...
export const DEMO_PILLARS = [
  { id: 1, name: "Health & Fitness", emoji: "\u{1F4AA}", color: "#EF4444", defaultBasePoints: 10, description: "Physical health, exercise, nutrition", userId: "demo" },
  { id: 2, name: "Career", emoji: "\u{1F4BC}", color: "#3B82F6", defaultBasePoints: 10, description: "Job search, skills, professional development", userId: "demo" },
  { id: 3, name: "Side Hustle", emoji: "\u{1F680}", color: "#8B5CF6", defaultBasePoints: 15, description: "Product development, content creation", userId: "demo" },
  { id: 4, name: "Home", emoji: "\u{1F3E0}", color: "#F59E0B", defaultBasePoints: 5, description: "Household chores and maintenance", userId: "demo" },
  { id: 5, name: "Growth", emoji: "\u{1F4D6}", color: "#10B981", defaultBasePoints: 10, description: "Personal development, reading, learning", userId: "demo" },
  { id: 6, name: "Family & Faith", emoji: "\u{1F468}\u200D\u{1F469}\u200D\u{1F467}", color: "#EC4899", defaultBasePoints: 10, description: "Family time, church, community", userId: "demo" },
];
...
export const DEMO_DASHBOARD = {
  score: {
    ...
    pillarScores: [
      { id: 1, name: "Health & Fitness", emoji: "\u{1F4AA}", color: "#EF4444", defaultBasePoints: 10, score: 20 },
      { id: 2, name: "Career", emoji: "\u{1F4BC}", color: "#3B82F6", defaultBasePoints: 10, score: 67 },
      { id: 3, name: "Side Hustle", emoji: "\u{1F680}", color: "#8B5CF6", defaultBasePoints: 15, score: 0 },
      { id: 5, name: "Growth", emoji: "\u{1F4D6}", color: "#10B981", defaultBasePoints: 10, score: 100 },
    ],
    totalTasks: 11,
    completedTasks: 4,
  },
  history: {
    scores: demoHistory,
    pillars: DEMO_PILLARS.map((p) => ({ id: p.id, name: p.name, emoji: p.emoji, color: p.color, defaultBasePoints: p.defaultBasePoints })),
  },
  momentum: {
    overall: 1.2,
    pillars: [],
