  ...
  return (
    <div className="container mx-auto px-4 py-4 md:py-8 max-w-4xl animate-pulse">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="h-9 w-40 bg-zinc-200 dark:bg-zinc-700 rounded-lg mb-2" />
            ...
            {[1, 2].map((o) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <div className="h-5 w-36 bg-zinc-200 dark:bg-zinc-700 rounded mb-1" />
                    <div className="h-4 w-48 bg-zinc-200 dark:bg-zinc-700 rounded" />
                  </div>
                  <div className="h-8 w-8 bg-zinc-200 dark:bg-zinc-700 rounded" />
                </div>
                <div className="h-3 w-full bg-zinc-200 dark:bg-zinc-700 rounded-full mb-1" />
